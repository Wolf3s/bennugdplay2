...
/*
		 if ( os_id == OS_GP2X_WIZ and joy_number() )   //Wiz
...
*/
            ...
            jkeys_state[ _JKEY_UP        ] |= JOY_PS2_UP(0);
            jkeys_state[ _JKEY_LEFT      ] |= JOY_PS2_LEFT(0);
            jkeys_state[ _JKEY_DOWN      ] |= JOY_PS2_DOWN(0);
            jkeys_state[ _JKEY_RIGHT     ] |= JOY_PS2_RIGHT(0);
            jkeys_state[ _JKEY_MENU      ] |= JOY_PS2_SELECT(0);
            jkeys_state[ _JKEY_SELECT    ] |= JOY_PS2_START(0);
            jkeys_state[ _JKEY_L         ] |= JOY_PS2_CROSS(0);
            jkeys_state[ _JKEY_R         ] |= JOY_PS2_CIRCLE(0);
            jkeys_state[ _JKEY_A         ] |= JOY_PS2_SQUARE(0);
            jkeys_state[ _JKEY_B         ] |= JOY_PS2_TRIANGLE(0);
            jkeys_state[ _JKEY_X         ] |= JOY_PS2_L1(0);
            jkeys_state[ _JKEY_Y         ] |= JOY_PS2_R1(0);
