...
*/
 ...
 #define YETI_VIEWPORT_X2_MAX 320
 #define YETI_VIEWPORT_Y2_MAX 240
 extern int YETI_VIEWPORT_X2 ;
 extern int YETI_VIEWPORT_Y2 ;
 extern int YETI_FRAMEBUFFER_WIDTH  ;
 extern int YETI_FRAMEBUFFER_HEIGHT ;
