...
/*
#ifdef __WIN32__
  #define YETI_RAY_WIDTH 50 //100
  #define YETI_RAY_MAX 512//1024
  #ifdef __YETI_EDITOR__
    #define YETI_CELL_MAX 4096
  #else
    #define YETI_CELL_MAX 512//1024
  #endif
#else
...
*/
  ...
  extern int YETI_RAY_WIDTH;
  extern int YETI_RAY_MAX;
  extern int YETI_CELL_MAX;
  #define YETI_CELL_MAX_MAX 1024

/******************************************************************************/

#define YETI_MODEL_BUCKET_MAX 16
#define YETI_MODEL_TRANGLE_MAX 4000
#define YETI_MODEL_VERTEX_MAX 4000
...
typedef STATICARRAY(point8_t, YETI_CELL_MAX_MAX) cell_vis_t;
